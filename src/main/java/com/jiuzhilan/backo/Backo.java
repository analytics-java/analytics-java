package com.jiuzhilan.backo;

import java.util.concurrent.TimeUnit;

/**
 * Backo implements the "full jitter" backoff policy as described in this
 * article
 * <a href="http://www.awsarchitectureblog.com/2015/03/backoff.html">Exponential
 * Backoff And Jitter </a>.
 * <p>
 * Create your own instance with the {@link Builder} class. Instances of backoff
 * are stateless, so you can create them once and share them across threads
 * throughout your app.
 *
 * @see <a href=
 *      "http://www.awsarchitectureblog.com/2015/03/backoff.html">Exponential
 *      Backoff And Jitter </a>
 */
public class Backo {
	...
	public static class Builder {
		...
		/**
		 * Set the backoff factor. Defaults to {@code 2}. Using a factor of {@code 2}
		 * will back off linearly.
		 */
