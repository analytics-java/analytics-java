...
public abstract class TrackMessage implements Message {
	...
	public static class Builder extends MessageBuilder<TrackMessage, Builder> {
		...
		@Override
		protected TrackMessage realBuild(Type type, String messageId, Date timestamp, Map<String, ?> context,
				String anonymousId, String userId, Map<String, Object> integrations) {
			return new AutoValue_TrackMessage(type, messageId, timestamp, context, anonymousId, userId, integrations,
					event, properties);
		}
	}
}
