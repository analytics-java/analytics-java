...
public abstract class ScreenMessage implements Message {
	...
	public static class Builder extends MessageBuilder<ScreenMessage, Builder> {
		...
		@Override
		protected ScreenMessage realBuild(Type type, String messageId, Date timestamp, Map<String, ?> context,
				String anonymousId, String userId, Map<String, Object> integrations) {
			return new AutoValue_ScreenMessage(type, messageId, timestamp, context, anonymousId, userId, integrations,
					name, properties);
		}
	}
}
