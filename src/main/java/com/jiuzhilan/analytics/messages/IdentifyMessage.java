...
/**
 * The identify call ties a customer and their actions to a recognizable ID and
 * traits like their email, name, etc.
 *
 * <p>
...
public abstract class IdentifyMessage implements Message {
	...
	public static class Builder extends MessageBuilder<IdentifyMessage, Builder> {
		...
		@Override
		protected IdentifyMessage realBuild(Type type, String messageId, Date timestamp, Map<String, ?> context,
			...
			return new AutoValue_IdentifyMessage(type, messageId, timestamp, context, anonymousId, userId, integrations,
					traits);
		}
