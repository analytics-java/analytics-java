...
public abstract class GroupMessage implements Message {
	...
	public static class Builder extends MessageBuilder<GroupMessage, Builder> {
		...
		/**
		 * Set a map of information you know about a group, 
		 * like number of employees or website.
		 */
		...
		@Override
		protected GroupMessage realBuild(Type type, String messageId, Date timestamp, Map<String, ?> context,
				String anonymousId, String userId, Map<String, Object> integrations) {
			return new AutoValue_GroupMessage(type, messageId, timestamp, context, anonymousId, userId, integrations,
					groupId, traits);
		}
