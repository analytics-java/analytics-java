...
public abstract class PageMessage implements Message {
	...
	public static class Builder extends MessageBuilder<PageMessage, Builder> {
		...
		@Override
		protected PageMessage realBuild(Type type, String messageId, Date timestamp, Map<String, ?> context,
				String anonymousId, String userId, Map<String, Object> integrations) {
			return new AutoValue_PageMessage(type, messageId, timestamp, context, anonymousId, userId, integrations,
					name, properties);
		}
	}
}
