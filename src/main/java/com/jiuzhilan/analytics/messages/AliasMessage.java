...
/**
 * The alias message is used to merge two user identities, effectively
 * connecting two sets of user data as one. This is an advanced method, but it
 * is required to manage user identities successfully in some of our
 * integrations.
 *
 * <p>
...
public abstract class AliasMessage implements Message {
	 ...
	 *
	 * @param previousId The previous unique identifier for the user. See the
	 *                   Previous ID field docs for more detail.
	...
	public static class Builder extends MessageBuilder<AliasMessage, Builder> {
		...
		@Override
		protected AliasMessage realBuild(Type type, String messageId, Date timestamp, Map<String, ?> context,
				String anonymousId, String userId, Map<String, Object> integrations) {
			return new AutoValue_AliasMessage(type, messageId, timestamp, context, anonymousId, userId, integrations,
					previousId);
		}
